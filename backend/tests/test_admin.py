...
from models import Incident, Project, Subscription, SubscriptionStatus, SubscriptionTier, User
...
class TestAdminUsers:
    ...
    def test_get_admin_user_by_id(self, admin_auth_headers, regular_user):
        ...
        response = client.get(f"/admin/users/{regular_user.id}", headers=admin_auth_headers)
        assert response.status_code == 200
    ...
    def test_admin_cannot_remove_own_admin_privileges(self, admin_auth_headers, admin_user):
...
class TestAdminSubscriptions:
    ...
    def test_get_admin_subscriptions_pagination(self, admin_auth_headers, sample_data):
        ...
        response = client.get("/admin/subscriptions?skip=0&limit=1", headers=admin_auth_headers)
        assert response.status_code == 200
...
class TestAdminProjects:
    ...
    def test_get_admin_projects_pagination(self, admin_auth_headers, sample_data):
        ...
        response = client.get("/admin/projects?skip=1&limit=1", headers=admin_auth_headers)
        assert response.status_code == 200
...
class TestAdminIncidents:
    ...
    def test_get_admin_incidents_filter_resolved(self, admin_auth_headers, sample_data):
        ...
        response = client.get("/admin/incidents?resolved=false", headers=admin_auth_headers)
        assert response.status_code == 200
        ...
        response = client.get("/admin/incidents?resolved=true", headers=admin_auth_headers)
        assert response.status_code == 200
    ...
    def test_get_admin_incidents_pagination(self, admin_auth_headers, sample_data):
        ...
        response = client.get("/admin/incidents?skip=0&limit=1", headers=admin_auth_headers)
        assert response.status_code == 200
