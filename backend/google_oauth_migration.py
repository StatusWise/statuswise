...
def get_database_url():
    ...
    return os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/statuswise")
    ...
    try:
        with engine.connect() as connection:
            ...
            if not has_hashed_password:
                print("✅ Migration already completed. No hashed_password column found.")
                return
            ...
            if user_count > 0:
                ...
                print("📝 Note: Existing users will need to sign in with Google using the same email address.")
                print("   Their accounts will be automatically linked when they first sign in with Google.")
            ...
            try:
                ...
                if user_count > 0:
                    ...
                    print("   • Users can sign in with Google using their existing email")
                    print("   • Accounts will be automatically linked on first Google sign-in")
...
if __name__ == "__main__":
    try:
        ...
        if verify_migration():
            ...
            print("You can now start your application with Google OAuth authentication.")
        else:
